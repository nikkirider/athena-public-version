...
#pragma omp simd
        for (int i=is; i<=ie; ++i) {
          prim(fluidnum,n,k,js-j,i) = sign * prim(fluidnum,n,k,js+j-1,i);
        }
      }
    }
  }
...
#pragma omp simd
        for (int i=is; i<=ie; ++i) {
          prim(fluidnum,IIE,k,js-j,i) = sign * prim(fluidnum,IIE,k,js+j-1,i);
        }
      }
    }
    }
...
#pragma omp simd
        for (int i=is; i<=ie; ++i) {
          prim(fluidnum,n,k,je+j,i) = sign * prim(fluidnum,n,k,je-j+1,i);
        }
      }
    }
  }
...
#pragma omp simd
        for (int i=is; i<=ie; ++i) {
          prim(fluidnum,IIE,k,je+j,i) = sign * prim(fluidnum,IIE,k,je-j+1,i);
        }
      }
    }
    }
